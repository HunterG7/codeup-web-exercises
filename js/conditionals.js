...
//     } else {
//         return `I do not know anything that is the color ${color}.`
//     }
// }
...
// console.log(analyzeColor(randomColor));
    ...
    let userColor = prompt("Please give me a random color.");
    ...
    const calculateTotal = (luckyNum, totalPrice) => {
        switch (luckyNum) {
            case 0:
                return totalPrice;
                break;
...
// Generate a random number between 0 and 6
    ...
    let userBill = prompt("What is the total for your bill?");
    alert(`Your luck number was ${luckyNumber}, and your new total is ${calculateTotal(luckyNumber, userBill)}.`);
